sed -i '' "s/str4d/arhash/g" `grep str4d -rl --exclude-dir=.git --exclude=replace.sh .`
...
sed -i '' "s/str4d/arhash/g" `grep str4d -rl --exclude-dir=.git --exclude=replace.sh .`
sed -i '' "s/github.com\/zclassic\/zclassic/github.com\/arhash\/arhash/g" `grep github\.com\/zclassic\/zclassic -rl --exclude-dir=.git --exclude=replace.sh .`
